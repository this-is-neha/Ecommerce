...
const LoginPage = () => {
  ...
  const handleForgotPassword = async () => {
    try {
      ...
      await axiosInstance.post('http://localhost:9004/auth/reset', { email }, {
...
//         auth.setLoggedInUser(response.data.result.detail); // ✅ Update context properly
//       }
...
// import { useForm } from "react-hook-form";
// import { TextInputField } from "../../../components/common/form";
// import axiosInstance from "../../../config/axios.config"; // ✅ Correct import
// import { toast } from "react-toastify";
// import * as Yup from "yup";
// import { yupResolver } from "@hookform/resolvers/yup";
// import { AuthContext } from "../../../context/auth.context";
...
//       auth?.setLoggedInUser(response.data.result.detail); // ✅ Correct usage
...
//   // ✅ Redirect if already logged in (avoid flicker with a loading check if added later)
//   useEffect(() => {
//     if (auth?.loggedInUser) {
//       toast.info("You are already logged in");
//       navigate("/");
...
//               <button
//                 type="submit"
//                 className="flex w-full mt-14 text-xl justify-center rounded-md bg-indigo-600 px-3 py-2.5 text-m font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500"
//               >
//                 Sign in
//               </button>
//             </div>
